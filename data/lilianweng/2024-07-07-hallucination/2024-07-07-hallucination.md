...
- [Extrinsic Hallucinations in LLMs](#extrinsic-hallucinations-in-llms)
...
Factual-nucleus sampling leads to be better diversity and less repetition then the standard nucleus sampling, while the hallucination error is measured in [named entity (NE) error](#ne-error). (Image source: [Lee et al. 2022](https://arxiv.org/abs/2206.04624))
